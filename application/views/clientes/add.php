...
<input type="date" class="form-control form-control-user" name="cliente_data_nascimento" placeholder="Data nascimento" value="<?php echo set_value('cliente_data_nascimento'); ?>">
...
<?php echo form_error('cliente_obs','<small class="form-text text-danger">','</small>');  ?>
               ...
               <a title="Cadastrar novo cliente" href="<?php echo base_url('clientes') ?>" class="btn btn-success btn-sm ml-2">Voltar</a>
                   </form>
