...
<input type="date" class="form-control form-control-user" name="cliente_data_nascimento" placeholder="Data nascimento" value="<?php echo $cliente->cliente_data_nascimento; ?>">
...
<input type='hidden' name='cliente_id' value='<?php echo $cliente->cliente_id; ?>'/>
               ...
               <a title="Cadastrar novo cliente" href="<?php echo base_url('clientes/add') ?>" class="btn btn-success btn-sm ml-2">Voltar</a>
                   </form>
