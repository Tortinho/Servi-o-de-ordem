                                ...
                                <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           <td class="text-right"> 
                                             <a title='Editar' href='<?php echo base_url('usuarios/edit/'.$user->id); ?>' class='btn btn-sms btn-primary'><i class="fas fa-user-edit"></i></a>
                                             <a title='Excluir' href='javascript(void)' data-toggle="modal" data-target="#user-<?php echo $user->id; ?>" class='btn btn-sms btn-danger'><i class="fas fa-user-times"></i></a>
                                           </td>
                                        </tr>
