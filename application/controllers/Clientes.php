         ...
         if($this->form_validation->run()){
          ...
          exit;*/
            ...
            /* 
             ...
             [cliente_data_nascimento] => 1998-05-10
             [cliente_cpf] => 186.014.210-91
             [cliente_rg_ie] => 18.967.492-1
             [cliente_email] => asasasas@gmail.com
             [cliente_telefone] => (21) 3333-3333
             [cliente_celular] => (21) 96713-1648
             [cliente_endereco] => rua do aprendizado
             [cliente_numero_endereco] => 93
             [cliente_complemento] => corra atras dos seus objetivos
             [cliente_bairro] => estude que voce alcança
             [cliente_cep] => 80540-000
             [cliente_cidade] => Nova iguaçu
             [cliente_estado] => RJ
             [cliente_ativo] => 1
             [cliente_obs] => O bagulho é doido
             [cliente_tipo] => 1
             [cliente_id] => 1
     ...
     public function edit($cliente_id = NULL) {
         ...
         if(!$cliente_id || !$this->core_model->get_by_id('clientes', array('cliente_id' => $cliente_id))){
             ...
             redirect('clientes');
              ...
              /*
                      [cliente_id] => 1
            [cliente_data_cadastro] => 2021-05-19 14:33:25
            [cliente_tipo] => 2
            [cliente_nome] => Lucio
            [cliente_sobrenome] => Souza
            [cliente_data_nascimento] => 0000-00-00
            [cliente_cpf_cnpj] => 25.566.887/8798-54
            [cliente_rg_ie] => 
            [cliente_email] => 
            [cliente_telefone] => 
            [cliente_celular] => 
...
public function del($cliente_id = NULL)  {
  ...
  if(!$cliente_id || !$this->core_model->get_by_id('clientes', array('cliente_id' => $cliente_id))) {
      ...
      $this->session->set_flashdata('error', 'clientes não encontrado');
      redirect('clientes');
